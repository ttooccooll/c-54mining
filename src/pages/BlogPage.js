...
const BlogPage = () => {
  ...
  return (
    <div style={{ padding: '20px' }} className='quote' ref={quoteRef}>
      ...
      />
      <br/>
      <h1 id="solar" className='blog'>Do you work in the solar industry?</h1>
      ...
      />
      <br/>
      <h1 id="videos" className='blog'>Some Helpful Videos</h1>
      <p>!!! Note that all of these videos are currently FILLER MATERIAL and were not made by me. I don't even necessarily endorse them. I just wanted to put something here while I'm making this website. Please don't use these as your instruction yet. I have not even watched most of them. !!!</p>
      ...
      <h1 id="security" className='blog'>Home Bitcoin Mining, the Real Solar Boom, and National Security</h1>
      <img
