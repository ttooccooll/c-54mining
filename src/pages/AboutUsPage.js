  ...
  return (
    <div style={{ padding: '20px' }} className='quote' ref={quoteRef}>
      ...
      <div className='about2'>
        ...
        <p className='a1'>By running a local smart home, which never touches the internet, you can privately heat your home or utilize excess solar power while making this network more robust and secure. Using Bitcoin miners as heaters is more than a novelty—it's a statement that energy can be productive, that waste can be value, and that individuals can opt out of failing financial systems.</p>
        <p className='a1'>We also offer Home Assistant installation services to help you take control of your home automation without sacrificing privacy. Your data stays in your home, not in the cloud. Combined with Bitcoin mining heat, this gives you true energy independence—a home that works for you, not for corporations or governments.</p>
        <p className='a1'>Whether you're looking to heat your space with purpose or build a self-sovereign home, we're here to help you get there.</p>
      </div>
    </div>
  );
};
