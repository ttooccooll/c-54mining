...
const Home = () => {
  ...
  return (
    <div style={{ padding: '20px' }} className='quote' ref={quoteRef}>
      <h1>Welcome</h1>
      <p>Inspired by the Berlin Airlift, we aim to provide the tools for you to be a part of the most powerful movement of our generation enabling financial freedom to people worldwide.</p>
      <div id='q'>
