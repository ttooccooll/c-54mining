...
const Home = () => {
  ...
  return (
    <div style={{ padding: '20px' }} className='quote' ref={quoteRef}>
      ...
      <p className='homep'>Inspired by the Berlin Airlift, we aim to provide the tools for you to be a part of the most powerful movement of our generation, enabling financial inclusion to people worldwide.</p>
      <div id='q'>
